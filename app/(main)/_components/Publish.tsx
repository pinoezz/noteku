...
export function Publish({ initialData }: PublishProps) {
  ...
  const onPublish = () => {
    ...
    toast.promise(promise, {
      ...
      success: "Catatan dipublikasikan"
    })
  }
  ...
  const onUnPublish = () => {
    ...
    toast.promise(promise, {
      loading: "Mencabut publikasi...",
      success: "Catatan dicabut dari publikasi"
    })
  }
        ...
        {initialData.isPublished ? (
          <div className="space-y-4">
            <div className="flex gap-x-2 items-center">
              ...
              <p className="text-xs font-medium text-sky-500">
                Catatan ini sudah dipublikasikan
              </p>
            </div>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <span className="text-xs text-muted-foreground mb-4">
              Bagikan pekerjaan Anda dengan orang lain.
            </span>
