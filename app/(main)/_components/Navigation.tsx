    ...
    <>
      <aside className={cn(
        ...
        <div>
          ...
          <div>
            <UserItem />
            <Item label="Pencarian" icon={Search} isSearch onClick={search.onOpen} />
            <Item label="Pengaturan" icon={Settings} onClick={settings.onOpen} />
            <Item onClick={handleCreate} label='Halaman Baru' icon={PlusCircle} />
          </div>
          <div className="mt-4">
            <DocumentList />
            <Item onClick={handleCreate} icon={Plus} label="" />
            <Popover>
